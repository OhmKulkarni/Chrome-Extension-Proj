// src/dashboard/dashboard-main-compatible.tsx
...
const Dashboard: React.FC = () => {
  ...
  const [detailViewer, setDetailViewer] = useState({
    open: false,
    item: null,
    type: 'request' as 'request' | 'error' | 'token',
    field: 'details'
  })
  ...
  // Carousel state for table navigation (EXACT MATCH TO ORIGINAL)
  ...
  // Carousel navigation functions (EXACT MATCH TO ORIGINAL)
  const nextTable = () => {
    ...
    try {
      ...
      setData(prevData => ({
        ...
        lastActivity: storageData.lastActivity 
          ...
          : 'Never',
        networkRequests: [], // Will be loaded by NetworkDashboard
        totalRequests: countsResponse?.requests || 0,
        consoleErrors: [], // Will be loaded by ErrorDashboard
        totalErrors: countsResponse?.errors || 0,
        tokenEvents: [], // Will be loaded by TokenDashboard
  ...
  const toggleGlobalPower = async () => {
    try {
      ...
      setData(prev => ({ ...prev, extensionEnabled: newState }))
  ...
  }, [loadDashboardData, loadTabsLoggingStatus])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                {data.extensionEnabled ? 'Disable Extension' : 'Enable Extension'}
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex gap-6">
          ...
          <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'mr-80' : ''}`}>
            ...
            {/* Table Navigation - EXACT MATCH TO ORIGINAL */}
                ...
                <div className="flex items-center justify-between">
                        ...
                        >
                          <span className="flex items-center space-x-2">
                            ...
                            <span className={`inline-flex items-center justify-center px-2 py-1 text-xs font-medium rounded-full ${
                              ...
                              {index === 0 ? data.totalRequests : 
                               index === 1 ? data.totalErrors : 
                               index === 2 ? data.totalTokenEvents :
                               0}
                            </span>
                          </span>
                        </button>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {tableDescriptions[currentTableIndex] || 'Real-time performance metrics and analytics'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Network Requests Table - EXACT STRUCTURE MATCH */}
            ...
            {/* Console Errors Table - EXACT STRUCTURE MATCH */}
            ...
            {/* Token Events Table - EXACT STRUCTURE MATCH */}
            ...
            {/* Performance Monitoring - EXACT STRUCTURE MATCH */}
            <div className={`bg-white rounded-lg shadow mb-8 ${currentTableIndex === 3 ? 'block' : 'hidden'}`}>
              <PerformanceMonitoringDashboard />
            </div>

            {/* Statistics Card Component - EXACT MATCH TO ORIGINAL */}
            <StatisticsCard 
          ...
          {/* Sidebar - EXACT MATCH TO ORIGINAL STRUCTURE */}
          {sidebarOpen && (
      ...
      {/* Detail Viewer - EXACT MATCH TO ORIGINAL */}
      {detailViewer.open && (
